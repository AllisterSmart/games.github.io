...
<section >
  ...
  <div class="wallet-container text-center" style="margin-top: -10px; padding-bottom: 15px;">
    ...
    <div class="amount-box text-center">
      ...
      <p>Total Balance</p>
     <p class="amount"><img src="{{ asset('web/images/coins.png') }}">{{ $balance }}</p>
  ...
  <div class="container">
    <div class="wallet-container text-center" style="margin-top: -12.9rem;; padding-bottom: 25px; margin-left: -8.2rem;">
        <p class="page-title"><i class="fa fa-align-left"></i>Recharge Wallet<i class="fa fa-user"></i></p>
        <div class="amount-box text-center">
            <p>Wallet Recharge</p>
             <form method="POST" action="{{ route('razorpay.recharge') }}">
                @csrf
                <div class="form-group">
                    <label for="amount"></label>
                    <input type="number" name="amount" id="amount" class="form-control mt-3" value="{{ old('amount') }}" required>
                </div>
                <div class="row">
        <div class="col-md-6">
        ...
        <div class="col-md-6">
            <button type="button" class="btn cancel" onclick="closeForm()" style="padding: 5px 42px;">Close</button>
        </div>
    </div>
            </form>
        </div>
...
<script>
    function openRazorpay() {
        var amount = document.getElementById('add_balance').value;
        if (amount <= 0) {
