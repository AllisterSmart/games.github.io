...
<div class="container mt-5">
    ...
    <textarea class="form-control" id="discreption" name="discreption" rows="5"></textarea>
</div>
...
<h4 class="mt-5" style="background: aquamarine;padding: 5px;">Project Information</h4>
        ...
        <div class="col-md-6">
            ...
            <input type="text" class="form-control" id="d_amount" name="d_amount" >
        </div>
    </div>
    ...
    <h4 class="mt-5" style="background: aquamarine;padding: 5px;">Second Payment Information</h4>
        ...
        <div class="col-md-6">
            <label for="date" class="form-label formlabel mt-3">Date</label>
           <input type="date" class="form-control" id="date2" name="date2"  min="<?php echo date('Y-m-d'); ?>">
        </div>
        <div class="col-md-6">
            <label for="p2_amount" class="form-label formlabel mt-3">Paid Amount</label>
            <input type="text" class="form-control" id="p2_amount" name="p2_amount" >
        </div>

        <div class="col-md-6">
            <label for="p2_amount" class="form-label formlabel mt-3">Due Amount</label>
            <input type="text" class="form-control" id="d2_amount" name="d2_amount" >
        </div>
    </div>
    ...
    <h4 class="mt-5" style="background: aquamarine;padding: 5px;">Third Payment Information</h4>
        ...
        <div class="col-md-6">
            <label for="date" class="form-label formlabel mt-3">Date</label>
           <input type="date" class="form-control" id="date3" name="date3"  min="<?php echo date('Y-m-d'); ?>">
        </div>
        <div class="col-md-6">
            <label for="p3_amount" class="form-label formlabel mt-3">Paid Amount</label>
            <input type="text" class="form-control" id="p3_amount" name="p3_amount" >
        </div>

        <div class="col-md-6">
            <label for="d3_amount" class="form-label formlabel mt-3">Due Amount</label>
            <input type="text" class="form-control" id="d3_amount" name="d3_amount" >
        </div>
    </div>
    ...
    <h4 class="mt-5" style="background: aquamarine;padding: 5px;">Fourth Payment Information</h4>
        ...
        <div class="col-md-6">
            <label for="date" class="form-label formlabel mt-3">Date</label>
           <input type="date" class="form-control" id="date4" name="date4"  min="<?php echo date('Y-m-d'); ?>">
        </div>
        <div class="col-md-6">
            <label for="p4_amount" class="form-label formlabel mt-3">Paid Amount</label>
            <input type="text" class="form-control" id="p4_amount" name="p4_amount" >
        </div>

        <div class="col-md-6">
            <label for="d4_amount" class="form-label formlabel mt-3">Due Amount</label>
            <input type="text" class="form-control" id="d4_amount" name="d4_amount" >
        </div>
    </div>
