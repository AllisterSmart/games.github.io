                        ...
                        <div class="card card-with-nav">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        <h4>
                                            <a href="{{ url('createtournaments') }}" class="btn btn-primary float-end mt-1">Add New Tournament</a>
                                        </h4>
                                    </div>
                                </div>
                                        ...
                                        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>{{ $tournament->id }}</td>
                                                    <td> 
                                                    <form id="deleteForm" action="{{ route('deletetournaments', ['id'=> $tournament->id]) }}" method="get">
                <input type="hidden" value="{{ $tournament->id }}" name="id">
                <a href="{{ route('edittournaments', ['id'=> $tournament->id]) }}"><i class="bi-pencil-square" style="text-decoration: none; display: inline-block;"> Edit</i></a>&nbsp;
